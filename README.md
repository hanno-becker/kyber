...
**NOTE: This repository is an archive of the reference implementation of ML-KEM/Kyber developed during and for the NIST PQC standardization project. Please see [mlkem-native](https://github.com/pq-code-package/mlkem-native) for a production-ready and actively maintained continuation of this repository.**
